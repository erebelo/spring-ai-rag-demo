package com.erebelo.springairagdemo;
...
class SpringAIRAGDemoApplicationTest {
    ...
    void mainRunSuccessful() {
        try (MockedStatic<SpringApplication> mockedStatic = mockStatic(SpringApplication.class)) {
            ...
            SpringAIRAGDemoApplication.main(new String[]{});

            mockedStatic.verify(() -> SpringApplication.run(SpringAIRAGDemoApplication.class, new String[]{}));
        }
    }
}
